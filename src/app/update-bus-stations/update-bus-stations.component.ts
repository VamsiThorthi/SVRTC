...
@Component({
  selector: 'app-update-bus-stations',
  templateUrl: './update-bus-stations.component.html',
  styleUrls: ['./update-bus-stations.component.css']
})
export class UpdateBusStationsComponent implements OnInit {
  ...
  function(){
    this.busService.updateBusStation( this.station, (this.addStation?.value)-1, this.busId).subscribe((data1) => {
